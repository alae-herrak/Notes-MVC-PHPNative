    ...
    <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none">
            ...
            <div class="collapse navbar-collapse" id="navcol-5">
                ...
                </ul><a class="btn btn-primary ms-md-2" role="button" href="?action=AddNote">Add Note</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container position-relative">
            <div class="row d-flex justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5 card-custom" style="border-radius: 9px;background: linear-gradient(145deg, #c39ec3, #e8bbe8);box-shadow: 5px 5px 1px #b895b8, -5px -5px 1px #fac9fa;">
                        <div class="card-body p-sm-5">
                            <h2 class="text-center mb-4">Add Note</h2>
                            <form action="?action=AddNote" method="post">
                                <div class="mb-3"><input class="form-control" type="text" id="name-2" name="NoteTitle" placeholder="Note Title"></div>
                                <div class="mb-3"></div>
                                <div class="mb-3"><textarea class="form-control" id="message-2" name="NoteContent" rows="10" placeholder="Note Content"></textarea></div>
                                <div><button class="btn btn-primary d-block w-100" type="submit" name="AddNote">Add</button></div>
                            </form>
                        </div>
                    </div>
                </div>
